...
│   │   ├── 2kai.tex - 2回生総括
│   │   ├── 3kai.tex - 3回生総括
│   │   ├── kaisou.tex - 会計総務局 総括用フォルダの内容を\input{}するファイル（自動生成）
...
│   │   ├── 2kai.tex - 2回生方針
│   │   ├── 3kai.tex - 3回生方針
│   │   ├── kaisou.tex - 会計総務局 方針用フォルダの内容を\input{}するファイル（自動生成）
